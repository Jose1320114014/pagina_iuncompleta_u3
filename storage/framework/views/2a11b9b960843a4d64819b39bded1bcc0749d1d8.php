...
<!--------------------------------------
Main  foreach ($resultados as $resultado){
            echo "<tr>";
		...
		<div class="col-md-8">
			...
			<div class="card border-0 mb-5 box-shadow">
				...
				<div class="card-body px-0 pb-0 d-flex flex-column align-items-start">
					...
					<a class="text-dark" href="./article.html">Estos fueron los valientes que aceptaron ser registrados al formulario antes de que explotara el form</a>
					</h2>
					<p class="card-text">
...
</html><?php /**PATH C:\xampp\htdocs\HackSick!\HackSick!\resources\views/category.blade.php ENDPATH**/ ?>