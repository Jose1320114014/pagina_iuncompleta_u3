...
<div class="container">
	<a class="navbar-brand" href="<?php echo e(Route('index')); ?>"><strong>HackSick!</strong></a>
	...
	<div class="navbar-collapse collapse" id="navbarColor02" style="">
		<ul class="navbar-nav mr-auto d-flex align-items-center">
			<li class="nav-item">
			<a class="nav-link" href="<?php echo e(Route('index')); ?>">Inicio <span class="sr-only">(current)</span></a>
			</li>
			<li class="nav-item">
			<a class="nav-link" href="<?php echo e(Route('infohack')); ?>">Ando aburrido</a>
			</li>
			<li class="nav-item">
			<a class="nav-link" href="<?php echo e(Route('category')); ?>">Quien ha usado esto</a>
		...
		<div class="pl-4 pr-0 h-100 tofront">
			<div class="row justify-content-between">
				<div class="col-md-6 pt-6 pb-6 align-self-center">
					<h1 class="secondfont mb-3 font-weight-bold">¿Que es Hacksick?</h1>
					<p class="mb-3">
						Hacksick es una aplicacion que... te ayuda a perder el tiempo, sip, solo eso, ah y para poder ver recomendaciones de los generos de Musica que han sido relevantes, como generos indie o simplemente musica que es de culto.
		...
		<div class="col-lg-6">
			<div class="card border-0 mb-4 box-shadow h-xl-300">              
				...
				<div class="card-body px-0 pb-0 d-flex flex-column align-items-start">
					...
					<a class="text-dark" >Cientificos afirman que usar el cerebro y escuchar musica aumenta tus capacidades de razonamiento</a>
					</h2>
					<p class="card-text">
						 Tal como lo oye, debido a una investigacion en la que los cientificos afirman que usar el cerebro y escuchar musica aumenta tus capacidades de razonamiento, asi que si, esta noticia es beneficiosa para ayudar a que esta pagina crezca y vea si algunos de sus amigos ya ha usado esta aplicacion completamente util y que para nada hara hacer perder tu tiemo.
					</p>
					<div>
						<small class="d-block"><a class="text-muted" href="https://blog-de-eme-erre.herokuapp.com/">"YHARONSMOKE"  </a>,the creation test</small>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="flex-md-row mb-4 box-shadow h-xl-300">
				<div class="mb-3 d-flex align-items-center">
					...
					<div class="pl-3">
						...
						<a class="text-dark" href="./article.html">¿Que le hace la musica a nuestro cerebro?</a>
						</h2>
...
</html><?php /**PATH C:\xampp\htdocs\HackSick!\HackSick!\resources\views/index.blade.php ENDPATH**/ ?>