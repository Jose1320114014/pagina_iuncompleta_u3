...
<div class="container pt-4 pb-4">
	<div class="row justify-content-center">
		...
		<div class="col-md-12 col-lg-8">
			...
			<p>
				 Actividad: <?php echo e($datos['activity']); ?>

			</p>
			<p>
				<a>Que tan accesible es del 0.0 al 1?:  </a><?php echo e($datos['accessibility']); ?>

			</p>
			<p>	
				<a>Tipo :</a> <?php echo e($datos['type']); ?>

			</p>
			<p>	
				<a>Personas que pueden entrar: </a><?php echo e($datos['participants']); ?>

		   </p>
		   <p>	
			<a>
				precio de la actvividad: </a><?php echo e($datos['price']); ?>
...
</html><?php /**PATH C:\xampp\htdocs\HackSick!\HackSick!\resources\views/hack.blade.php ENDPATH**/ ?>